...
@Data
public class MicropayPreAuthRequest extends BaseTransRequest {
     ...
     * 业务小类
     */
    private String busiSubType = BusiSubType.B2C_MICROPAY_PRE_AUTHORIZATION.getFlag();
    /**
     * 交易类型
     */
    ...
    public void validate() {
        super.validate();
        //授权码格式判断
        ParamAssert.notBlank(authCode, "支付授权码不能为空");
